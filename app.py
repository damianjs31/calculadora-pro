...
st.subheader("TU BRO LA IA MUEJEJE")

pregunta = st.text_area("Haz una pregunta teórica")
    ...
    if pregunta:
        try:
            respuesta = client.chat.completions.create(
                model="gpt-4.1-mini",
                messages=[
                    {"role": "system", "content": "Eres un profesor de matemáticas que explica fácil y paso a paso."},
